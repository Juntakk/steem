import melvorImage from "../images/melvor.jpg";
import hellbladeImage from "../images/hellblade.jpg";
import ori2Image from "../images/ori_2.jpg";
import dsImage from "../images/ds.jpg";
import ds2Image from "../images/ds2.jpg";
import ds3Image from "../images/ds3.jpg";
import brotatoImage from "../images/brotato.jpg";
import vampireImage from "../images/vampire.jpg";
import dogmaImage from "../images/dogma.jpg";
import skyrimImage from "../images/skyrim.jpg";
import sekiroImage from "../images/sekiro.jpg";
import ori1Image from "../images/ori_1.jpg";
import kenaImage from "../images/kena.jpg";
import gowImage from "../images/gow.jpg";
import deadspaceImage from "../images/deadspace.jpg";
import hollowknightImage from "../images/hollowknight.jpg";
import div2Image from "../images/div2.jpg";
import twentyMinutesImage from "../images/20m.png";
import eldenImage from "../images/elden.jpg";
import curseImage from "../images/curse.jpg";
import celesteImage from "../images/celeste.png";
import gungeonImage from "../images/gungeon.jpg";
...
const data = [
  ...
  },
  {
    ...
    category: "Souls-like",
    description:
      "THE NEW FANTASY ACTION RPG. Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between. A rich lore and challenging fights are what await you.",
    price: "79.99$",
    rating: "Extremely positive",
    image: eldenImage,
  },
  ...
  },
  {
    ...
    category: "Adventure",
    description:
      "Experience Aloy’s legendary quest to unravel the mysteries of a future Earth ruled by Machines. Use your wits to take down foes, explore a stunning open world, and uncover the fate of the world.",
    price: "49.99$",
    rating: "Very positive",
    image: horizonImage,
  },
